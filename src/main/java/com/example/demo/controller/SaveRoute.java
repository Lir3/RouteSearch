...
public class SaveRoute {
    ...
    @Autowired
    private CommuterpassDataRepository commuterpassDataRepository;
    ...
    public ResponseEntity<String> saveRoute(@RequestBody RouteSaveRequest request, HttpSession session) {
        ...
        Optional<CommuterpassData> commuterPassOpt = commuterpassDataRepository.findByUsername(username);
        ...
        commuterpassDataRepository.save(commuterPass);
